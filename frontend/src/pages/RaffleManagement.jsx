...
import { formatTicketDate, formatRaffleDate } from '../utils/dateUtils';
...
const RaffleManagement = () => {
    ...
    const filteredTickets = React.useMemo(() => {
        return tickets.filter(t => {
            ...
            const fullDate = formatTicketDate(t.createdAt);
                                        ...
                                        >
                                            ...
                                            <td className="px-2 md:px-6 py-4">
                                                <div className="flex flex-col items-center justify-center space-y-1">
                                                    <p className="text-[9px] md:text-[10px] text-gray-400 font-bold uppercase tracking-widest">{formatTicketDate(ticket.createdAt)}</p>
