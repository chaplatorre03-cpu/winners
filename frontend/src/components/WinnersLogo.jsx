...
const WinnersLogo = ({ size = 'medium', className = '' }) => {
  ...
  return (
    ...
    >
      ...
      <div className="neo-punk-logo neo-punk-container relative z-10 flex items-center bg-gray-900 rounded-xl px-5 py-1 md:py-2.5 border-2 border-[#8b00ff]/30 overflow-hidden transition-all duration-500 group-hover:border-[#ff00de]/80 group-hover:bg-black group-hover:brightness-[1.5]">
